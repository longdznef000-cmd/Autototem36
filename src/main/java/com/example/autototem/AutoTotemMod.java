    ...
    private void equipTotemToMainHand(ServerPlayerEntity player) {
        ...
        for (int slot = 0; slot < 9; slot++) {
            ...
            if (stack.isOf(Items.TOTEM_OF_UNDYING)) {
                ...
                LOGGER.info("Da tu dong chuyen Totem of Undying ra tay chinh cho {}", player.getName().getString());
                return;
            }
        }
        ...
        if (!slotOneStack.isEmpty()) {
            slotOneStack.set(net.minecraft.component.DataComponentTypes.CUSTOM_NAME,
                    net.minecraft.text.Text.literal("longg210"));
